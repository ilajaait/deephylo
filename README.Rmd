...
The goal of deephylo is to infer parameters from phylogeny with deep-learning.

## Installation

You can install the development version of deephylo from [GitHub](https://github.com/) with:
